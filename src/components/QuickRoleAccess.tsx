    ...
    return (
      <div>
        ...
        <p className="mb-4 text-center text-xs text-slate-500">
          New here?{' '}
          <Link to="/" className="font-semibold text-stone-600 hover:text-stone-700">
        ...
        {ROLE_CONFIG.map((config) => {
          ...
          return (
            <button
              ...
              className={`min-h-[2.75rem] rounded-lg px-3 py-2 text-xs font-semibold transition-all duration-200 ${
                isActive
